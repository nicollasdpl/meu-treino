...
function salvarSessaoAtual(duracao){
  ...
  // Atualiza gráficos se a aba estiver aberta
...
function refreshGraficosSeAbaAberta(exerciciosDaSessao){
  ...
  // foca no último exercício com peso
